...
func (it *iterSSHCredential) Next(ctx context.Context) bool {
...
func (it *iterSSHCredential) Item() *ngrok.SSHCredential {
...
func (it *iterSSHCredential) Err() error {
	return it.err
}
