...
func (it *iterStaticBackend) Next(ctx context.Context) bool {
...
func (it *iterStaticBackend) Item() *ngrok.StaticBackend {
...
func (it *iterStaticBackend) Err() error {
	return it.err
}
