...
func (c *Client) Replace(ctx context.Context, arg *ngrok.EndpointWebhookValidationReplace) (*ngrok.EndpointWebhookValidation, error) {
	if arg == nil {
...
func (c *Client) Get(ctx context.Context, id string) (*ngrok.EndpointWebhookValidation, error) {
