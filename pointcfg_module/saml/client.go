...
func (c *Client) Replace(ctx context.Context, arg *ngrok.EndpointSAMLReplace) (*ngrok.EndpointSAML, error) {
	if arg == nil {
...
func (c *Client) Get(ctx context.Context, id string) (*ngrok.EndpointSAML, error) {
