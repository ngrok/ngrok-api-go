...
func (c *Client) Replace(ctx context.Context, arg *ngrok.EndpointOIDCReplace) (*ngrok.EndpointOIDC, error) {
	if arg == nil {
...
func (c *Client) Get(ctx context.Context, id string) (*ngrok.EndpointOIDC, error) {
