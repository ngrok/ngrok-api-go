...
func (c *Client) Replace(
	ctx context.Context, arg *ngrok.EndpointTLSTerminationReplace) (*ngrok.EndpointTLSTermination, error) {
	if arg == nil {
...
func (c *Client) Get(
	ctx context.Context, id string) (*ngrok.EndpointTLSTermination, error) {
