...
func (c *Client) Replace(
	ctx context.Context, arg *ngrok.EndpointRequestHeadersReplace) (*ngrok.EndpointRequestHeaders, error) {
	if arg == nil {
...
func (c *Client) Get(
	ctx context.Context, id string) (*ngrok.EndpointRequestHeaders, error) {
