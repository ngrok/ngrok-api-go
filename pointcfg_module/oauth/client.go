...
func (c *Client) Replace(ctx context.Context, arg *ngrok.EndpointOAuthReplace) (*ngrok.EndpointOAuth, error) {
	if arg == nil {
...
func (c *Client) Get(ctx context.Context, id string) (*ngrok.EndpointOAuth, error) {
